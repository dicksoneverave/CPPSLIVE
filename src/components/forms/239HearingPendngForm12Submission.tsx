            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={!validIRN || generatingForm8}
                  className="btn bg-primary text-white hover:bg-primary-dark text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {generatingForm8 ? 'Generating...' : 'Generate Form 8 PDF'}
                </button>
              </div>
            </div>
            <p className="text-textSecondary">Click the buttons above to view required documents or generate Form 8.</p>
            {form8Message && (
