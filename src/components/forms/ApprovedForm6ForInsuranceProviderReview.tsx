...
import ListApprovedForm6ForInsuranceProviderReview from '../../ListApprovedForm6ForInsuranceProviderReview'

interface ApprovedForm6ForInsuranceProviderReviewProps {
  irn: string;
  incidentType: 'Injury' | 'Death';
  onClose: () => void;
}

const ApprovedForm6ForInsuranceProviderReview: React.FC<ApprovedForm6ForInsuranceProviderReviewProps> = ({
  irn,
  incidentType,
  onClose,
}) => {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white z-10">
          <h2 className="text-xl font-semibold text-gray-900">
            Insurance Provider Response Approved {headingSuffix}
            {formData.DisplayIRN && (
        ...
        <div className="p-6 space-y-8">
          ...
          {/* Section: Form 6 - Notice to Worker */}
...
export default ApprovedForm6ForInsuranceProviderReview;
