...
interface ForwardToTribunalTimebarredFormSubmissionRegistrarReviewProps {
  irn: number | string;
  incidentType: IncidentTypeKind; // expected: "Injury" | "Death"
  onClose: () => void;
}

const ForwardToTribunalTimebarredFormSubmissionRegistrarReview: React.FC<
  ForwardToTribunalTimebarredFormSubmissionRegistrarReviewProps
...
export default ForwardToTribunalTimebarredFormSubmissionRegistrarReview;
