...
import ApprovedClaimsAwardedForPaymentsSectionReview from './ApprovedClaimsAwardedForPaymentsSectionReview';

interface ListApprovedClaimsAwardedPaymentSectionReviewProps {
...
const ListApprovedClaimsAwardedPaymentSectionReview: React.FC<ListApprovedClaimsAwardedPaymentSectionReviewProps> = ({
  onClose,
  onSelectIRN,
}) => {
  // ----- state -----
  ...
  return !open ? null : view === 'decision' && selected ? (
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">
            Awarded Claims Payment Review (Approved) – {selected.irn} ({selected.incidentType})
          </h2>
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">Approved Awarded Claims</h2>
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Awarded Claims Approved to Display</p>
            </div>
          )}
...
export default ListApprovedClaimsAwardedPaymentSectionReview;
