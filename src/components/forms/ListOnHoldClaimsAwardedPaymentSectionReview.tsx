...
import OnHoldClaimsAwardedForPaymentsSectionReview from './OnHoldClaimsAwardedForPaymentsSectionReview';

interface ListPendingClaimsAwardedPaymentSectionProps {
...
const ListOnHoldClaimsAwardedPaymentSectionReview: React.FC<ListOnHoldClaimsAwardedPaymentSectionReviewProps> = ({
  onClose,
  onSelectIRN,
}) => {
  // ----- state -----
  ...
  return !open ? null : view === 'decision' && selected ? (
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">
            Awarded Claims Payment Review (OnHold) – {selected.irn} ({selected.incidentType})
          </h2>
        ...
        <div className="p-6">
          <OnHoldClaimsAwardedForPaymentsSectionReview
            irn={selected.irn}
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">OnHold Awarded Claims</h2>
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Awarded Claims OnHold to Display</p>
            </div>
          )}
...
export default ListOnHoldClaimsAwardedPaymentSectionReview;
