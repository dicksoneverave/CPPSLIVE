...
import OnHoldClaimsAwardedForPaymentsManagerReview from './OnHoldClaimsAwardedForPaymentsManagerReview';

interface ListOnHoldClaimsAwardedPaymentsManagerReviewProps {
...
const ListOnHoldClaimsAwardedPaymentsManagerReview: React.FC<ListOnHoldClaimsAwardedPaymentsManagerReviewProps> = ({
  onClose,
  onSelectIRN,
}) => {
  // ----- state -----
  ...
  const fetchClaimsList = async () => {
    try {
      ...
      let countQuery = supabase
        .from('onhold_awarded_claims_paymentsmanagerreview_view')
  ...
  return !open ? null : view === 'decision' && selected ? (
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">
            Awarded Claims For Payments Manager Review (OnHold) – {selected.irn} ({selected.incidentType})
          </h2>
        ...
        <div className="p-6">
          <OnHoldClaimsAwardedForPaymentsManagerReview
            irn={selected.irn}
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">OnHold Awarded Claims For Payments</h2>
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Awarded Claims For Payments OnHold to Display</p>
            </div>
          )}
...
export default ListOnHoldClaimsAwardedPaymentsManagerReview;
