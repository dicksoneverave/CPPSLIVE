...
// NOTE: You imported the default from "./PendingAwardedClaimsForRegistrarReview" as
// DecisionPendingAwardedClaimsForRegistrarReview — keeping that as-is.
import PendingAwardedClaimsForRegistrarReview from "./PendingAwardedClaimsForRegistrarReview";
...
const ListPendingAwardedClaimsForRegistrarReview: React.FC<ListPendingAwardedClaimsForRegistrarReviewProps> = ({ 
  ...
  // NEW: manage which view is active and what was selected
  ...
  // UPDATED: when Proceed is clicked, either call the parent callback
  // or switch to the Decision component and pass props.
...
{/* If we're in the Decision view, render that component and pass the required props. */}
if (view === 'decision' && selected) {
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">
            Registrar Review – {selected.irn} ({selected.incidentType})
          </h2>
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            >
              ← Back to Pending Awarded Claims
            </button>
          </div>

          {/* ✅ Use the same identifier as the import and the selected state */}
          <PendingAwardedClaimsForRegistrarReview
            irn={selected.irn}
