...
import PendingClaimsAwardedForPaymentSectionReview from './PendingClaimsAwardedForPaymentSectionReview';
...
const ListPendingClaimsAwardedPaymentSection: React.FC<ListPendingClaimsAwardedPaymentSectionProps> = ({
  onClose,
  onSelectIRN,
}) => {
  // ----- state -----
  ...
  const fetchClaimsList = async () => {
    try {
      ...
      let countQuery = supabase
        .from('pending_awarded_claims_paymentsection_view')
  ...
  return !open ? null : view === 'decision' && selected ? (
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">
            Awarded Claims Payment Review – {selected.irn} ({selected.incidentType})
          </h2>
        ...
        <div className="p-6">
          <PendingClaimsAwardedForPaymentSectionReview
            irn={selected.irn}
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">Pending Awarded Claims</h2>
...
export default ListPendingClaimsAwardedPaymentSection;
