...
import PendingClaimsAwardedForPaymentsManagerReview from './PendingClaimsAwardedForPaymentsManagerReview';

interface ListPendingClaimsAwardedPaymentsManagerReviewProps {
...
const ListPendingClaimsAwardedPaymentsManagerReview: React.FC<ListPendingClaimsAwardedPaymentsManagerReviewProps> = ({
  onClose,
  onSelectIRN,
}) => {
  // ----- state -----
  ...
  const fetchClaimsList = async () => {
    try {
      ...
      let countQuery = supabase
        .from('pending_awarded_claims_paymentsmanagerreview_view')
  ...
  return !open ? null : view === 'decision' && selected ? (
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">
            Awarded Claims For Payments Manager Review – {selected.irn} ({selected.incidentType})
          </h2>
        ...
        <div className="p-6">
          <PendingClaimsAwardedForPaymentsManagerReview
            irn={selected.irn}
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-900">Pending Awarded Claims For Payments</h2>
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No Awarded Claims For Payments Pending to Display</p>
            </div>
          )}
...
export default ListPendingClaimsAwardedPaymentsManagerReview;
