...
import RejectedClaimsAwardedForPaymentSectionReview from './RejectedClaimsAwardedForPaymentSectionReview';

interface ListRejectedClaimsAwardedPaymentSectionReviewProps {
...
const ListRejectedClaimsAwardedPaymentSectionReview: React.FC<ListRejectedClaimsAwardedPaymentSectionReviewProps> = ({
  onClose,
  onSelectIRN,
}) => {
  // ----- state -----
  ...
  return !open ? null : view === 'decision' && selected ? (
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <RejectedClaimsAwardedForPaymentSectionReview
            irn={selected.irn}
...
export default ListRejectedClaimsAwardedPaymentSectionReview;
