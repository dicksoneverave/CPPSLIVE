...
import ListClaimDecisions from './ListClaimDecisions'; // adjust if yours is './ListClaimDecisions'

// ----- Props -----
export interface PendingRegisteredClaimsRegistrarReviewProps {
...
const PendingRegisteredClaimsRegistrarReview: React.FC<PendingRegisteredClaimsRegistrarReviewProps> = ({
  irn,
  incidentType,
  onClose,
  className,
...
export default PendingRegisteredClaimsRegistrarReview;
