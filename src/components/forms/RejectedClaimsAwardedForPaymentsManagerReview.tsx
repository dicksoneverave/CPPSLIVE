...
const RejectedClaimsAwardedForPaymentsManagerReview: React.FC<Props> = ({
  IRN,
  irn,
  formType = 'Injury',
  onCloseAll,
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Payments Manager Review (Rejected) — {formType}
              </h2>
...
export default RejectedClaimsAwardedForPaymentsManagerReview;
