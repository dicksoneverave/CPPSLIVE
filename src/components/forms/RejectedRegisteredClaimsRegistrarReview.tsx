...
// ----- Props -----
export interface RejectedRegisteredClaimsRegistrarReviewProps {
...
const RejectedRegisteredClaimsRegistrarReview: React.FC<RejectedRegisteredClaimsRegistrarReviewProps> = ({
  irn,
  incidentType,
  onClose,
  className,
...
export default RejectedRegisteredClaimsRegistrarReview;
