...
interface RejectedTimebarredFormSubmissionRegistrarReviewProps {
  irn: number | string;
  incidentType: IncidentTypeKind; // expected: "Injury" | "Death"
  onClose: () => void;
}

const RejectedTimebarredFormSubmissionRegistrarReview: React.FC<
  RejectedTimebarredFormSubmissionRegistrarReviewProps
...
export default RejectedTimebarredFormSubmissionRegistrarReview;
