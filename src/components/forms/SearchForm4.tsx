...
interface SearchResult {
  ...
  timebarredBlock: boolean; // true → disable Proceed
}
...
const normalizeTB = (raw?: string | null): TBStatus => {
  ...
  if (up === 'onhold' || up === 'keeponhold') return 'OnHold';
  if (up === 'approved') return 'Approved';
	if (up === 'forwardtotribunal') return 'ForwardToTribunal';
  // pass-through anything else (e.g., ForwardToTribunal)
  return v;
};
