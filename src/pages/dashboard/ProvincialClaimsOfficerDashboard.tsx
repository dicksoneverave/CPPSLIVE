...
const ProvincialClaimsOfficerDashboard: React.FC = () => {
  ...
  // ✅ New modals for Employer and Attachments
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // 2) F6 Employer Response Pending
        {
          const base = supabase
            .from('form6master')
  ...
  const menuItems: Record<string, { items: string[] }> = {
    ...
    Form17: { items: [] },
    Form7:   { items: [] },
    Employer: { items: ['Edit Employer', 'View Employer'] },     // ✅ NEW
    Attachments: { items: ['Injury Case', 'Death Case'] },       // ✅ NEW
  };
